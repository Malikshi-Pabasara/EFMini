...
namespace Cenium.Reservations.Activities
{
    ...
    public class ReservationsActivity : IDisposable
    {
        ...
        public Reservation CheckIn(Reservation reservation)
        {
            ...
            // Refresh Order
            reservation = _ctx.Reservations.ReadOnlyQuery().FirstOrDefault(o => o.ReservationId == reservation.ReservationId);
        ...
        public List<long> GetReservedRoomIdList(long reservationId)
        {
            ...
            // Get reservation
            var reservation = _ctx.Reservations.ReadOnlyQuery().FirstOrDefault(o => o.ReservationId == reservationId);
        ...
        {
            return _ctx.Reservations.ReadOnlyQuery().FirstOrDefault(p => p.ReservationId == reservationId);
        }
